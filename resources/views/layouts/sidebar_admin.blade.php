    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ route('schedules.index') }}" class="nav-item nav-link {{ Request::routeIs('schedules.index') ? 'active' : '' }}">
                <i class="fa-regular fa-calendar-days"></i>Lớp học
            </a>
            <a href="{{ route('trainers.index') }}" class="nav-item nav-link {{ Request::routeIs('trainers.index') ? 'active' : '' }}">
                <i class="fa-solid fa-user-tie"></i>Huấn luyện viên
            </a>
